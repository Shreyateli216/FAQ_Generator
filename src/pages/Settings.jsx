...
import { Key, Server, Lock, AlertTriangle, Eye, EyeOff } from 'lucide-react';
...
export default function Settings() {
  ...
  return (
    <div className="max-w-[800px] mx-auto py-4">
      <h1 className="text-2xl font-bold font-heading mb-6">Platform Settings</h1>
            ...
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  defaultValue="gsk_xyz1234567890abcdef"
                />
        ...
        <section className="glass-card p-6 border-l-4 border-l-[#A855F7]">
          <div className="flex items-center justify-between mb-6">
            ...
            <button 
              ...
              className={`w-12 h-6 rounded-full relative transition-colors ${privacyMode ? 'bg-[#A855F7]' : 'bg-white/20'}`}
            >
              <div className={`w-4 h-4 rounded-full bg-white absolute top-1 transition-all ${privacyMode ? 'left-7' : 'left-1'}`}></div>
            </button>
          </div>
          
          <div className="bg-black/20 rounded-lg p-4 border border-white/5 flex gap-4">
            <div className="pt-0.5">
              <Server className={`w-5 h-5 ${privacyMode ? 'text-[#A855F7]' : 'text-white/40'}`} />
            </div>
            <div>
              ...
              <div className="flex gap-4">
                <div className="flex-1">
                   ...
                   <select disabled={!privacyMode} className="w-full bg-black/40 border border-white/10 rounded px-2 py-1.5 text-xs text-white disabled:opacity-50">
